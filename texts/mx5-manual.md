...
エアロタイプが流行りっぽいけど、ロードスターのキャラクターには合わなさそうなのでAUTOBACKS QUALITYのノーマルワイパーにした。
...
レベルゲージの取っ手がいつの間にか割れて消えた、と言うのが定番ネタらしい。

まさかwとエンジンルームを見たらはじけ飛んでいた。ええ……（困惑）

商品コード：BP4W-10-450 2898円

## プラグについて

点火系メンテの定番ネタと言えばプラグ交換。

納車整備は車検通しとオイル交換のみだったので、一体いつから交換されていないのか不明。

番手で特性が変わるらしいが、良く分からんので大人しく純正相当品にするのが良いのかなあ。
